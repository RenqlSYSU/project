...
!======================================================================= 
  ...
  subroutine held_suarez_1994(pcols, ncol, clat, pmid, &
    ...
    !-----------------------------------------------------------------------
    ! 
    ! Modified to output the equilibrium temperature profile as a history
    ! field - Isla Simpson 3rd June 2017.  Mods are denoted by 
    !
    ! !OUTFLD
    ! blah blah blah
    ! !END-OUTFLD 
    ...
    !OUTFLD
    real(r8), intent(out) :: trefout(pcols,pver) !tref array for output
    !END-OUTFLD 
