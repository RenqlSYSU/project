...
! *** MOD START ***
  ...
  public trelax   ! The V field that will be relaxed into the model
! *** MOD STOP ***
...
! *** MOD START ***
  ...
  real(r8), allocatable:: trelax(:,:,:,:)    ! Relaxed V flag
! *** MOD STOP ***
...
!-----------------------------------------------------------------------
    ...
    if(.not. (adiabatic .or. ideal_phys)) then
       ...
       ! *** MOD START ***
       allocate (urelax  (pcols,pver,begchunk:endchunk,365)) ! 365 --- timeframe
       allocate (vrelax  (pcols,pver,begchunk:endchunk,365))
       allocate (trelax  (pcols,pver,begchunk:endchunk,365))
       ! *** MOD STOP ***
