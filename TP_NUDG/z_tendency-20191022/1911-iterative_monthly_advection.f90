!***************************************************************************
!use the 3 advection term to calc dzdt by SOR (Successive Over Relaxation)
...
program iteration 
    implicit none
    integer, parameter :: pr = 8 , ncase = 3 , nvar = 3, ntime = 2, nlev = 18   
    ...
    logname = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/f90_iteration_infor_monthly_advection.txt"
    var_name = (/"b1","b2","b3"/) 
    ...
    read(*,*) nc
    if(nc.eq.1) then 
        filename = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/CTRL-Clim_MJJA_3advection_monthly.dat"
        fileout  = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/CTRL-Clim_dzdt_monthly_advection.dat"     
    else if(nc.eq.2) then
        filename = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/NUDG6h-Clim_MJJA_3advection_monthly.dat"
        fileout  = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/NUDG6h-Clim_dzdt_monthly_advection.dat"     
    else
        filename = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/NUDG24h-Clim_MJJA_3advection_monthly.dat"
        fileout  = "/home/ys17-19/renql/project/TP_NUDG/z_tendency-20191022/mdata/NUDG24h-Clim_dzdt_monthly_advection.dat"     
    end if
