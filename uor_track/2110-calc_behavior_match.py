...
if drawbox == 1:
    ...
    for nr in range(4,len(lats),1):
        ...
        cfp.setvars(file="traj-match-"+prefix+"_"+suffix+suffix2+".png")
        ...
        cfp.gclose()
        subprocess.run("mogrify -bordercolor white -trim ./traj-match-"+prefix+"_"+suffix+suffix2+".png",shell=True) 
