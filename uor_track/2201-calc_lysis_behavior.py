...
def calcbehv():
    ...
    for nl in range(0,len(lev),1):
        ...
        var[0,nl,:] = cyc_filter.lys_behavior(filname,
...
def drawbox():
    ...
    cfp.gopen(figsize=[20, 20],rows=(len(behv)-1),columns=len(lev),
            wspace=0.1,hspace=0.02,bottom=bmlo) #0.55
...
if len(sys.argv) < 2 :
    ...
    prefix = "ff"
    suffix0 = "_5_2545-60110_2_2545-6060"
...
behv = ["LYS" ,"LSW" ,"LSM","LSE" ]#,"DIF"]
lats = [flatn ,flats ,flats ,flats ]
latn = [flatn ,flatn ,flatn ,flatn ]
lonl = [flonl ,60    ,75    ,90    ]
lonr = [flonr ,75    ,90    ,105   ]
lev = [850,500,250]
